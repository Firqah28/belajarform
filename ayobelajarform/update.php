            ...
            <div class="card-body">
                <form method="post" action="proses_update.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="umur" class="form-control" id="umur" value="<?php echo $d['umur'] ?>" placeholder="Umur Siswa" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_lahir" class="form-control" value="<?php echo $d['tgl_lahir'] ?>" id="tgl_lahir" placeholder="Tanggal Lahir Siswa" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="hobi[]" <?php if (in_array("Ngoding", $datahobi)) echo "checked";?> id="inlineCheckbox1" value="Ngoding">
                            <label class="form-check-label" for="inlineCheckbox1">Ngoding</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="hobi[]" <?php if (in_array("Gamer", $datahobi)) echo "checked";?> id="inlineCheckbox2" value="Gamer">
                            <label class="form-check-label" for="inlineCheckbox2">Gamer</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="hobi[]" <?php if (in_array("Futsal", $datahobi)) echo "checked";?> id="inlineCheckbox3" value="Futsal">
                            <label class="form-check-label" for="inlineCheckbox3">Futsal</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Deskripsi Siswa</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Deskripsi Siswa" name="deskripsi" rows="3"><?php echo $d['deskripsi'] ?></textarea>
                    </div>
                    <div class="form-group">
